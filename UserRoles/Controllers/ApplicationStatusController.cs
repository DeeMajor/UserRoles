...
namespace UserRoles.Controllers
{
    public class ApplicationStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StatusID,Application_status")] ApplicationStatus applicationStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StatusID,Application_status")] ApplicationStatus applicationStatus)
        {
            if (ModelState.IsValid)
            {
